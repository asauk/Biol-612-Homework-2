...
ggplot(PCB_data, aes(x=PCB_data$Trophic.level, y=PCB_data$Individuals, fill = PCB_data$Effect))+geom_bar(stat="identity", position = position_dodge()) + labs(x = "Trophic Level", y = "Number of Individuals", title = "Fig. 6: Effects of PCBs on different trophic levels")
